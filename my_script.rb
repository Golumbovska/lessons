...
driver.find_element(id: 'user_login').send_keys 'golumbovska85'
...
driver.find_element(id: 'user_mail').send_keys 'golumbovska85@mail.com'
driver.find_element(name: 'commit').click

driver.find_element(class: 'logout').click

driver.find_element(class: 'register').click
driver.find_element(id: 'user_login').send_keys 'anastasiya44'
driver.find_element(id: 'user_password').send_keys 'golumbovska1234'
driver.find_element(id: 'user_password_confirmation').send_keys 'golumbovska1234'
driver.find_element(id: 'user_firstname').send_keys 'Nastya'
driver.find_element(id: 'user_lastname').send_keys 'Golumbovska'
driver.find_element(id: 'user_mail').send_keys 'anastasiya44@mail.com'
driver.find_element(name: 'commit').click

driver.find_element(class: 'logout').click

driver.find_element(class: 'login').click
driver.find_element(id:'username').send_keys 'golumbovska85'
...
driver.find_element(id: 'project_identifier').send_keys 'marynago58'
...
driver.find_element(:xpath, "//input[@id='principal_search']").send_keys 'anastasiya44'
driver.find_element(:xpath, "//input[@name='membership[user_ids][]'][1]" ).click #исправила я туууут
...
driver.find_element(:xpath, "//input[@name='membership[role_ids][]'and checked=true ][2]" ).click
