...
driver.find_element(id: 'user_login').send_keys 'golumbovska38'
...
driver.find_element(id: 'user_mail').send_keys 'golumbovska38@mail.com'
driver.find_element(name: 'commit').click

driver.find_element(class: 'logout').click

driver.find_element(class: 'login').click
driver.find_element(id:'username').send_keys 'golumbovska38'
...
driver.find_element(id: 'project_identifier').send_keys 'marynago15'
driver.find_element(name: 'continue').click


driver.find_element(:xpath, ".//*[@id='project_quick_jump_box']/option[3]").click #теперь все ок
